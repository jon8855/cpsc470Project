...
public class BlackJackClientT {
			...
			if (hasConnections) {
				...
				while (!hasConnections) {
					try {
						...
						SamplePlayer player = new TamraPlayer(100);
	...
	public BlackJackClientT(String serverIp, int port) {
	...
	public static void main(String[] args) {
		...
		new BlackJackClientT("127.0.0.1",4445);
		try {
